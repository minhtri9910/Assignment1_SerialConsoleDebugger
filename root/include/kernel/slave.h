...
enum
{
    ...
    BSC_SLAVE_RIS = (BSC_SLAVE_BASE + 0x1C),
    BSC_SLAVE_MIS = (BSC_SLAVE_BASE + 0x20),
    BSC_SLAVE_ICR = (BSC_SLAVE_BASE + 0x24),
    BSC_SLAVE_DMACR = (BSC_SLAVE_BASE + 0x28),
    BSC_SLAVE_TDR = (BSC_SLAVE_BASE + 0x2C),
    BSC_SLAVE_GPUSTAT = (BSC_SLAVE_BASE + 0x30),
    BSC_SLAVE_HCTRL = (BSC_SLAVE_BASE + 0x34),
    BSC_SLAVE_DEBUG1 = (BSC_SLAVE_BASE + 0x38),
    BSC_SLAVE_DEBUG2 = (BSC_SLAVE_BASE + 0x3C),
}
